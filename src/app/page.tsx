      ...
      <main className="mx-auto flex min-h-dvh w-full max-w-lg flex-col px-5 pb-7 pt-4">
        <div className="flex-1">
          ...
          <section className="mt-8 grid gap-4">
            ...
            <Link
              href="/library"
              className="relative mx-2 overflow-hidden rounded-[22px] border border-white/12 bg-slate-950/55 px-4 py-4 shadow-[0_16px_60px_rgba(0,0,0,0.40)] transition duration-200 hover:bg-slate-950/65 active:scale-[0.995]"
            >
